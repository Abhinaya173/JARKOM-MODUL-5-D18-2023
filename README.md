...
## Jawaban:
```
iptables -t nat -A POSTROUTING -s 192.200.0.0/16 -o eth0 -j SNAT --to-s 192.168.122.1
```
tujuan dari perintah ini adalah melakukan SNAT pada paket yang berasal dari jaringan dengan rentang IP 192.200.0.0/16, yang menuju keluar melalui antarmuka eth0, dengan mengubah alamat sumber mereka menjadi 192.168.122.1.
